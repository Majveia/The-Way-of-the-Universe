...
export function milkyWay(seed = 1): GalaxyParams {
  ...
  return {
    ...
    young: { lum: 4e9, scaleLength: 3500, rInner: 3000, rOuter: 17000, scaleHeight: 70, sfr: 1, armFraction: 0.8, colorT: 11000 },
    gas: { dust: 1.25, dustScaleLength: 5000, dustScaleHeight: 95, dustLane: 1.7, dustHole: 2600, hii: 1, nuclearRing: 230 },
    halo: { lum: 1.2e8, rMin: 1500, rMax: 70000, flatten: 0.65 },
