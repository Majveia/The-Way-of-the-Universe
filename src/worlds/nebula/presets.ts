...
export const PRESETS: Record<NebulaVariant, NebulaPreset> = {
  pillars: {
    ...
    source: { pos: [1.6, 2.1, 1.3], Q: 2e50, teff: 42000, lum: 1.2e6 },
    scatter: [],
    ...
    palette: 'true',
    views: {
      default: { distance: 6.2, yaw: 0.28, pitch: 0.06, target: [-0.35, -0.55, -0.4] },
      wide: { distance: 12.5, yaw: 0.45, pitch: 0.18, target: [0.1, -0.2, -0.3] },
      pillars: { distance: 5.2, yaw: 0.12, pitch: 0.05, target: [-0.6, -0.6, -0.2] },
      cluster: { distance: 7.5, yaw: 2.4, pitch: 0.55, target: [1.4, 1.6, 0.8] },
